...
- [ ] Follows the patterns in [ARCHITECTURE.md](https://github.com/TaterTotterson/CRT-Station/blob/main/ARCHITECTURE.md) and the principles in [CONTRIBUTING.md](https://github.com/TaterTotterson/CRT-Station/blob/main/CONTRIBUTING.md)
